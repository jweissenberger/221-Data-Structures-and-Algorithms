...
public class Simulation{
    public static void main(String[] args){
            ...
            switch(currentEvent.getType()){
                case ARRIVAL:
                    ...
                    if(queue.isEmpty()){
                        ...
                        queueDelay.accept(time-currentStudent.getArrivalTime());
                    }
                ...
                case DEPARTURE:
                    ...
                    if(!queue.isEmpty()){
                        ...
                        // calculate the queue delay
                        queueDelay.accept(time-nextStudent.getArrivalTime());
                    }
                    break;
                    default:
       ...
       // print the queue delay, like how it is done below
        ...
        // this prints out the information from the system delay
